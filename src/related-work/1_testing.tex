...
\begin{definition}[Trace]
    ...
    \xRightarrow{\sigma} \}$ with $p$ being a state of a LTS.
\end{definition}
...
In addition, \emph{runs}, which represent \emph{event sequences},
can also be derived from LTS semantics \cite{Tre96}:
