...
Testing shows the presence, not the absence of bugs as Edsger
Wybe Dijkstra used to say \cite{Buxton:1970:SET:1102021}.
...
explained \cite{Myers:1979:AST:539883}, testing is used to find
...
(V\&V) process \cite{wallace1989software}. We use to (informally)
...
\textit{test data}, \emph{i.e.}  inputs which have been devised to test
...
\TODO{link between two paragraphs}
...
Yet, this classification can not be generally accepted as
...
detail or \emph{phase} as shown in Figure
\ref{fig:sorts-of-testing}):

\begin{itemize}
\item \textbf{Unit Testing:} units (\emph{e.g.}, functions, methods,
...
construct the test cases, \emph{i.e.} accessibility:

\TODO{ref for each W,G,B}
...
and white-box approaches.\TODO{grey-box?}
...
also be applied using a black-box approach though, \emph{e.g.},
...
technique acts on the source code by mutating it, \emph{i.e.}  seeding
