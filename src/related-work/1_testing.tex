...
\begin{definition}[Runs and traces]
    ...
    \alpha_0 \dots \alpha_{n-1} q_n$ is an alternate finite
    sequence of states and valued actions.
...
\begin{itemize}
    ...
    focus on \emph{Component-based System Testing}: in this case, passive
