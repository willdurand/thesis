...
Such an hypothesis has been expressed by our partner.

In this thesis, we propose a solution for making Michelin's
...
\begin{itemize}
    ...
    \item The generation of the test cases based on these models
        ...
        systems. Due to the nature of these systems, the testing
        method should scale.
\end{itemize}
