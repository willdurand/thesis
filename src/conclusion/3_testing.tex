...
widely used. Furthermore, in this thesis, we only covered offline
passive testing of production systems, but it would be
interesting to see how active testing could be integrated with
\textit{Autofunk}.
